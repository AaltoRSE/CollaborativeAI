...
const App = () => {
  ...
  return (
    <>
      ...
      {isFinished && <FeedbackForm topic={mealDescription} messages={messages} viewPointRef={viewPointRef} isRatingSubmitted={isRatingSubmitted} setIsRatingSubmitted={setIsRatingSubmitted}/>}
      <Footer />
    </>
  );
};
